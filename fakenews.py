...
model = load_model('C:/Users/odhia/OneDrive/Desktop/streamlit tut/fakenews.keras')
tokenizer = pickle.load(open('newstokenizer.pkl','rb'))
...
def analyse_func():
    ...
    return render_template('fakenews.html', text=msg)
